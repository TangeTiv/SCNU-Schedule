...
fun CourseInstanceListScreen(
    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                actions = {
                    ...
                    IconButton(
                        ...
                        val descriptionRes = if (isSelectionMode) R.string.a11y_exit_selection_mode else R.string.a11y_enter_selection_mode
        ...
        // 列表部分保持原样，仅将 onNavigateToEditCourse 回调传入卡片
        LazyVerticalGrid(
